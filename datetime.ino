...
{
  Serial.begin(9600);
  rtc.writeProtect(false); // Use correct method name
  rtc.halt(false);
  lcd.init();  //initialize the lcd
  lcd.backlight();  //open the backlight 

  // Define the date and time (year, month, day, hour, minute, second, day of week)
  Time t(2024, 5, 15, 21, 21, 0, 3); // Set the date to May 15, 2024, and the time to 21:20:00, Wednesday
